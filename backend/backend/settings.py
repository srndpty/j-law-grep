...
OPENSEARCH_DIET_INDEX = os.environ.get("OPENSEARCH_DIET_INDEX", "jdiet-current")
OPENSEARCH_SHUISHO_INDEX = os.environ.get("OPENSEARCH_SHUISHO_INDEX", "jshuisho-current")
OPENSEARCH_SCHEMA_VERSION = int(os.environ.get("OPENSEARCH_SCHEMA_VERSION", "8"))
